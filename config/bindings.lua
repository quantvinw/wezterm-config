...
local function split_pane_with_cwd(split_action)
...
local keys = {
  ...
  -- panes: split panes
  {
    key = [[/]],
    mods = mod.SUPER_REV,
    action = split_pane_with_cwd(act.SplitVertical),
  },
  {
    key = [[\]],
    mods = mod.SUPER_REV,
    action = split_pane_with_cwd(act.SplitHorizontal),
  },
  {
    key = [[-]],
    mods = mod.SUPER_REV,
  ...
  { key = "j", mods = "CTRL|SHIFT", action = act.ActivatePaneDirection("Up") },
